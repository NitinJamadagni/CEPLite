...
public class SourceStream extends Thread{
	String streamId;
	String queueId;
	...
	public SourceStream(String name,CEPLiteContext in_context,String... schema) throws lessArgumentsException, UnknownHostException
	{
		streamId=name;
		context=in_context;
		//outputHandler=null;
